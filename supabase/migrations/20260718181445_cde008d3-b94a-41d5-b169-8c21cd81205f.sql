-- search_jobs v2.1: cast min_years (smallint in the table) to the declared
-- integer — RETURN QUERY EXECUTE is strict about type identity where v1's
-- plain-SQL body auto-coerced. Everything else unchanged.
