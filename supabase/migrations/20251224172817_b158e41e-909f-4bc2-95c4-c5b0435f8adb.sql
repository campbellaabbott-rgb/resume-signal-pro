-- Fix the track_ab_event_optimized function to use TEXT for visitor_id
-- The ab_test_events.visitor_id column is TEXT, not UUID
CREATE OR REPLACE FUNCTION public.track_ab_event_optimized(
  p_test_name TEXT,
  p_variant TEXT,
  p_event_type TEXT,
  p_visitor_id TEXT,  -- Changed from UUID to TEXT
