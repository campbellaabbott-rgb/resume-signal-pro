    ...
    parameters: {
      ...
      properties: {
        industry: {
          ...
          description: "Detected industry. Pick the single best-matching value. Use 'technology' ONLY for software engineers, web developers, DevOps, SRE, security engineers — NOT for data or AI roles. Use 'data_engineering' for data engineers, analytics engineers, ETL/pipeline engineers, data architects, BI engineers. Use 'data_science' for data scientists, data analysts, BI analysts, quantitative analysts, research scientists. Use 'machine_learning' for ML engineers, AI engineers, LLM engineers, GenAI engineers, prompt engineers, MLOps engineers, computer vision engineers, NLP engineers. Use 'product_management' for PMs, TPMs, product owners, scrum masters. Use 'creative' for designers, UX, art directors, animators, photographers, copywriters. Use 'engineering' only for non-software engineering (civil, mechanical, electrical, chemical). Use 'hr' for human resources/recruiting/talent. Use 'hospitality' for hotels/restaurants/travel/tourism. Use 'general' only when no other category fits."
        },
