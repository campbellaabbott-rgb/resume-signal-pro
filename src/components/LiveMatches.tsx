  ...
  if (failed || (matches !== null && matches.length === 0)) {
    return (
      <div className="mb-4">
        ...
        >
          {t("freeResults.matches.openBoardFallback", "Open the live job board — 450,000+ verified openings, ranked against your resume")}
      ...
      {matches === null ? (
        ...
        <>
          ...
          <p className="text-[11px] text-muted-foreground text-center mt-2">
            {t("freeResults.matches.openBoardNote", "450,000+ verified openings · save searches, watch companies, track applications")}
          </p>
        </>
      )}
    </div>
