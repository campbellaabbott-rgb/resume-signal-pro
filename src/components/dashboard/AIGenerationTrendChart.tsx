        ...
        {payload.map((entry: any, index: number) => (
          <div key={index} className="flex items-center justify-between gap-3 text-sm">
            ...
            <span className="font-semibold tabular-nums">
              {entry.name.includes('Duration') ? `${(entry.value/1000).toFixed(1)}s` : entry.value}
            </span>
          </div>
        ))}
      </div>
      ...
      <CardContent className="pt-0">
        ...
        <div className="flex items-center justify-between gap-2 mb-3 py-2 border-b border-border/50">
          <div className="flex items-center gap-4">
            <div>
              <p className="text-xl font-bold tabular-nums">{totalGenerations}</p>
          ...
          <div className="text-right">
            <p className="text-xl font-bold tabular-nums">{(avgDuration/1000).toFixed(1)}s</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-xs">No AI generations</p>
          </div>
        )}
      </CardContent>
    </Card>
