  ...
  return (
    <div className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-lg">How You Compare</h3>
        {industry && (
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <span>Industry Average: {avgScore}</span>
          <span>Top Performers: {topScore}+</span>
        </div>
        ...
        {score < avgScore && (
          <div className="p-3 rounded-xl bg-warning/5 border border-warning/20">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-warning">To Average</span>
            </div>
        ...
        {score < topScore && (
          <div className="p-3 rounded-xl bg-success/5 border border-success/20">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-semibold text-success">To Top Tier</span>
            </div>
        ...
        {score >= topScore && (
          <div className="col-span-2 p-3 rounded-xl bg-success/5 border border-success/20 text-center">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="font-semibold text-success">You're a Top Performer!</span>
            </div>
          </div>
        )}
      </div>
      ...
      {expConfig && (
        <div className="p-3 rounded-xl bg-muted/50 border border-border">
          <div className="flex items-start gap-2">
            ...
            <div>
              <span className="text-xs font-semibold text-primary capitalize">{experienceLevel} Level Tip</span>
      ...
      {targetRole && (
        <div className="text-center pt-2 border-t border-border">
          <p className="text-xs text-muted-foreground">
            Benchmarked against other <span className="font-medium text-foreground">{targetRole}</span> candidates
          </p>
        </div>
      )}
    </div>
