            ...
            {isFreeScanLoading ? (
              ...
              <>
                <Button
                  variant="hero"
                  size="xl"
                  disabled={isLoading || isFreeScanLoading || !canProceed}
                  onClick={onFreeScan || (resumeMode === "paste" ? handleTextPaste : handleCheckoutClick)}
                  ...
                  aria-busy={isLoading || isFreeScanLoading}
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      ...
                      {onFreeScan && (
                        <span className="px-2 py-0.5 rounded-full bg-white/20 text-xs font-bold">FREE</span>
                      )}
                    </>
                  )}
                </Button>
                ...
                <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-muted-foreground max-w-sm mx-auto">
                ...
                <p className="text-xs text-muted-foreground/70">
                  {onFreeScan ? "Free analysis • Results in ~90 seconds" : "Results delivered instantly"}
                </p>

                {/* Payment info - only show for paid */}
                {!onFreeScan && (
