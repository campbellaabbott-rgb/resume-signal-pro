...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO title={"Terms of Service "} description={" Resume Booster"} path={"Read the Resume Booster terms governing use of the resume analysis, rewrite, and career tools.|/terms"} />
      <Header />
      <main className="flex-1 py-16">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">3. Description of Service</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">5. User Responsibilities and Prohibited Conduct</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">10. Dispute Resolution and Arbitration</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">13. Force Majeure</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">16. Waiver</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">18. Modifications to Terms</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-foreground">19. Privacy</h2>
              <p className="text-muted-foreground leading-relaxed">
