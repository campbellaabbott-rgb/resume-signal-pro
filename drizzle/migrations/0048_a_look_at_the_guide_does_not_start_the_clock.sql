...
-- Applied unedited from
-- supabase/migrations/20260917230000_a_look_at_the_guide_does_not_start_the_clock.sql
...
BEGIN
  ...
  -- ACTIVATION: a resource read is looking, not doing, and looking must not
  -- start a paid clock (a prompt read never reaches here).
